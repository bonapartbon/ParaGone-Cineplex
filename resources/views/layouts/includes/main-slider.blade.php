...
<section class="w3l-main-slider position-relative" id="home">
        <div class="companies20-content">
            <div class="owl-one owl-carousel owl-theme">
                <div class="item">
                    <li>
                        <div class="slider-info banner-view bg bg2" style="background-image: url({{secure_asset('template-images/banner1.jpg')}})">
                ...
                <div class="item">
                    <li>
                        <div class="slider-info  banner-view bg bg2" style="background-image: url({{secure_asset('template-images/banner2.jpg')}})">
                            <div class="banner-info">
                                <h3>Black Widow</h3>
                ...
                <div class="item">
                    <li>
                        <div class="slider-info banner-view bg bg2" style="background-image: url({{secure_asset('template-images/banner3.jpg')}})">
                            <div class="banner-info">
                                <h3>Lupin</h3>
                ...
                <div class="item">
                    <li>
                        <div class="slider-info banner-view bg bg2" style="background-image: url({{secure_asset('template-images/banner4.jpg')}})">
                            <div class="banner-info">
                                <h3>Mortal Kombat</h3>
